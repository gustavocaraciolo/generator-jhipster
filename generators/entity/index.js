        ...
        return {
            validateFile() {
                ...
                context.fields.forEach((field) => {
                    ...
                    if (!_.isUndefined(field.fieldValidateRules)) {
                        ...
                        if (_.includes(field.fieldValidateRules, 'typepl') && _.isUndefined(field.fieldTypePL)) {
                            this.error(chalk.red(`fieldTypePL is missing in .jhipster/${entityName}.json for field ${JSON.stringify(field, null, 4)}`));
                        }
            ...
            loadInMemoryData() {
                ...
                context.fields.forEach((field) => {
                    ...
                    if (_.isUndefined(field.fieldTypePL)) {
                        field.fieldTypePL = field.fieldTypePL ?
                            field.fieldTypePL.replace(/\\/g, '\\\\').replace(/"/g, '\\"') : field.fieldTypePL;
                    }
